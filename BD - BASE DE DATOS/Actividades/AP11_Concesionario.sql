...
-- Tiempo de generación: 13-04-2025 a las 11:25:42
...
--
-- Estructura de tabla para la tabla `registroscompras`
--

CREATE TABLE `registroscompras` (
  `Cod_Registro` int(4) NOT NULL,
  `Mat_Ant` varchar(9) DEFAULT NULL,
  `Mat_Nuev` varchar(9) DEFAULT NULL,
  `Precio_Ant` decimal(5,2) DEFAULT NULL,
  `Precio_Nuev` decimal(5,2) DEFAULT NULL,
  `Usuario` varchar(20) DEFAULT NULL,
  `F_Compra` date DEFAULT NULL,
  `F_Reg_Compra` datetime DEFAULT NULL,
  `Acción` varchar(15) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Indices de la tabla `registroscompras`
--
ALTER TABLE `registroscompras`
...
--
-- AUTO_INCREMENT de la tabla `registroscompras`
--
ALTER TABLE `registroscompras`
